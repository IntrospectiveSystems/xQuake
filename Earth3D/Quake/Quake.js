...
//			let r = 6371;
			let r = 6450;
			rlat = Math.PI * com.Lat / 180.0;
			rlon = Math.PI * (com.Lon + loncor) / 180.0;
			var z = r * Math.sin(rlat);
			var rxy = r * Math.cos(rlat);
			var x = rxy * Math.cos(rlon);
			var y = rxy * Math.sin(rlon);
			console.log(x, y, z);
			Vlt.Picks[Vlt.iPick].position.set(x, y, z);
			...
			Vlt.iPick = 0;
			Vlt.Picks = [];
			let geo = new THREE.SphereGeometry(20, 6, 6);
